...
export default class NativeUI {
    ...
    public _buttonsEnabled: boolean = true;
    ...
    public readonly SelectTextLocalized: string = alt.Gxt.get("HUD_INPUT2");
    public readonly BackTextLocalized: string = alt.Gxt.get("HUD_INPUT3");
    ...
    constructor(title: string, subtitle: string, offset: Point, spriteLibrary?: string, spriteName?: string) {
        ...
        alt.Timers.everyTick(this.render.bind(this));
